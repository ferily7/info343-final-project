        ...
        render() {
            ...
            return (
                <ComposedComponent
                    ...
                    selectedItemStyle={this.props.children[0] &&
                        this.props.children[0][this.state.selectedIndex] &&
                        this.props.selectedTrip === this.props.children[0][this.state.selectedIndex].key ?
                        selectedItemStyle : {}}
                >
                    {this.props.children}
                </ComposedComponent>
                ...
                <div className="sidebar">
                    <div className="sidebar-content">
                        ...
                        <div className="trip-list">
                            ...
                            <SelectableList selectedTrip={this.props.selectedTrip} defaultValue={0}>
                                {this.state.dataRef &&
