...
class Budget extends Component {
    ...
    handleDeleteDialogOpen = (d) => {
        this.setState({ deleteDialogOpen: true, catToDelete: d });
    };
    ...
    render() {
        ...
        const deleteDialogActions = [
            ...
            <RaisedButton
                label="Delete"
                primary={true}
                onClick={() => this.handleDeleteCategory(this.state.catToDelete)}
            />
        ];
        let combinedObj = {};
        let combinedArr = [];
                                ...
                                <td>
                                    {d !== "Uncategorized" && (
                                        <span
                                            ...
                                            onClick={() => this.handleDeleteDialogOpen(d)}
                                        >
                                            <FontAwesomeIcon
                                                className="fa-spacer"
                                                icon={faTrashAlt}
                                            ...
                                            >
                                                ...
                                                <span className="extra-bold">"{`${this.state.catToDelete}`}"</span> category? This
